...
export const button = cva(
  ...
  ],
  {
    variants: {
      size: {
        sm: 'h-8 px-3 pointer-coarse:max-lg:text-sm',
        md: 'h-10 pointer-coarse:max-lg:h-11 px-4 pointer-coarse:max-lg:px-4.5',
        lg: [
          'h-11',
          'pointer-coarse:max-lg:h-12',
          'px-6',
          'pointer-coarse:max-lg:px-6.5',
          'font-medium',
        ],
      },
    ...
    compoundVariants: [
      {
        shape: ['square', 'circle'],
        class: 'p-0 pointer-coarse:max-lg:p-0 aspect-square',
      },
